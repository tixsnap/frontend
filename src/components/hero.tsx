      ...
      <div className="flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="w-full md:w-1/2 space-y-6 pl-10">
          ...
          <div className="flex gap-4">
            <button
              className="px-6 py-3 text-white text-lg font-bold rounded-3xl transition-transform: duration-200 hover:scale-110"
              style={{ backgroundColor: "#FF2E63" }}
            >
              Get Tickets
            </button>
            <button className="px-6 py-3 border-2 border-gray-300 text-white rounded-3xl transition-transform: duration-200 hover:scale-110 hover:bg-teal-400">
              Discover More
            </button>
          </div>
        </div>
