...
const EventListFromSearch = () => {
  const { getEventsByParams, events } = useEventStore();
  ...
  useEffect(() => {
    if (name) {
      ...
      getEventsByParams(searchParams);
    }
  }, [name, getEventsByParams]);
...
export default EventListFromSearch;
